...
CREATE TABLE technical (
	...
	content VARCHAR(65332) NOT NULL COMMENT '技术文章内容',
...
CREATE TABLE message (
	...
	message_time TIMESTAMP NOT NULL COMMENT '留言时间',
	state BIGINT(5) NOT NULL COMMENT '表示阅读状态,0表示未读,1表示已读',
...
CREATE TABLE statistic (
	statistic BIGINT(10) NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT '数据统计id',
