...
CREATE TABLE `history` (
  ...
  `visitor_num` bigint(10) DEFAULT '0' COMMENT '浏览量',
  `comment_num` bigint(10) DEFAULT '0' COMMENT '评论数量',
...
CREATE TABLE `message` (
  ...
  `message_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '留言时间',
  `state` bigint(5) NOT NULL COMMENT '表示阅读状态,0表示未读,1表示已读',
