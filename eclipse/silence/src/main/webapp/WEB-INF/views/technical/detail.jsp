...
<html>
	<head>
		...
		<meta name="Keywords" content="${technicalView.title }" />
				...
				<div class="row">
					<div class="col-lg-9 detail-box">
						...
						<div class="opinion-near">
							...
							<p>下一篇：
								<c:choose>
									<c:when test="${empty after }"><a href="<%=basePath %>technical/">回到分享生活</a></c:when>
									<c:otherwise><a href="<%=basePath %>technical/detail/${after.essayId }">${after.title }</a></c:otherwise>
								</c:choose>	
							</p>
						</div>
