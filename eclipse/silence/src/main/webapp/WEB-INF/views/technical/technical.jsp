...
<html>
	<head>
		...
		<meta name="Keywords" content="技术分享,陈涛的个人博客,陈涛,个人博客,个人,博客,Silence,Silencetao,涛涛,小涛涛" />
	...
	<body>
			...
			<div class="col-lg-6">
				<div class="technical-detail">
					...
					<div class="technical-content">
						...
						<a href="<%=basePath %>technical/detail/{technicalId}" class="link-button">详细信息</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="path-bar container clear-both">
			<div class="fl">
				<a href="<%=basePath %>">首页</a>&nbsp;/&nbsp;<a href="#" class="no-pointer">技术分享</a>
			</div>
		...
		<div class="toolbar hidden-md hidden-sm hidden-xs">
			<c:choose>
				...
				<c:otherwise>
					...
					<a href="<%=basePath %>technical/newtechnical" title="新建文章" class="toolbar-item toolbar-item-add">
						<span class="toolbar-btn"></span>
					</a>
				</c:otherwise>
			</c:choose>
