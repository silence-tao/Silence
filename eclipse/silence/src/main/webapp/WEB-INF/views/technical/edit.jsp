...
<html>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-9 left-box">
						...
						<div class="btn-group">
							<input type="button" onclick="toTechnicl()" value="舍弃编辑" />
							<input type="button" onclick="saveTechnical()" value="保存编辑" />
						</div>
					</div>
	...
	<script src="/silence/resources/js/technical/edit.js" type="text/javascript" charset="utf-8"></script>
