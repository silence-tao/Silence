...
<html>
	...
	<body>
		...
		<div class="path-bar container clear-both">
			<div class="fl">
				<a href="<%=basePath %>">首页</a>&nbsp;/&nbsp;<a href="<%=basePath %>/essay/technical">技术分享管理</a>&nbsp;/&nbsp;<a href="#" class="no-pointer">编辑技术分享</a>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-9 left-box">
						...
						<div class="btn-group">
							<input type="button" onclick="saveTechnical(-1)" value="不通过审核" />
							<input type="button" onclick="saveTechnical(1)" value="通过审核" />
						</div>
					</div>
	...
	<script src="/silence/resources/js/technical/audit.js" type="text/javascript" charset="utf-8"></script>
